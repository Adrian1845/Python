try:
	...
	class VElectricos(vehiculos):
		def __init__(self,marca,modelo):
			...
			self.autonomia=100
		def cargarBateria(self,cargando):
	...
	miFurgoneta.carga(True, "100kg")
	miFurgoneta.acelerar()
	miFurgoneta.estado()
	
	print("---Bicileta eléctrica---")
	miBiciE=bicicletaElectrica("Orbea","hj")
	miBiciE.cargarBateria(True)
	miBiciE.arrancar()
	miBiciE.frenar
	miBiciE.estado()
except SyntaxError:
